...
import { B as Block, S as Static, f as BlockLabel, Q as Code$2, h as Empty, j as IconButton, z as Copy$1, D as DownloadLink, k as Download$1, i as IconButtonWrapper, V as getWorkerProxyContext } from './2-aR-7a0xn.js';
...
const lang_map = {
  python: () => import('./index31-DwRWCokn.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index32-CRyR8IzH.js'),
      import('./frontmatter-CK1p-hZw.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index36-TrJ6PNA2.js').then((m) => m.json()),
  html: () => import('./index33-CJmgaqJX.js').then((m) => m.html()),
  css: () => import('./index34-D8sGJv1d.js').then((m) => m.css()),
  javascript: () => import('./index35-0ig2eTVG.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index35-0ig2eTVG.js').then(
...
//# sourceMappingURL=Index15-BUlCpiue.js.map
